...
if(isset($d->id) && $d->id != NULL){
    $result = mysql_query(sprintf("UPDATE winetype SET name = '%s', characteristics = '%s',"
    ...
    $result = mysql_query(sprintf("INSERT INTO winetype(name,characteristics,name_en,charact_en,"
   ...
   if($result){
            ...
            $result = mysql_query("SELECT * FROM winetype");
