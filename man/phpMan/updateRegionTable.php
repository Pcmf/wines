...
if(isset($d->id) && $d->id != NULL){
    $result = mysql_query(sprintf("UPDATE region SET name = '%s', characteristics = '%s'"
    ...
    $result = mysql_query(sprintf("INSERT INTO region(name,characteristics,charact_en,charact_fr,charact_be)"
            . " VALUES('%s','%s','%s','%s','%s')",
